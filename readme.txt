Please set up selenium web driver version 2.42.2 wich is compatible with firefox version 30.

To configure webdriver simply add external selenium jar file to classpath. For additional information please follow this link.
